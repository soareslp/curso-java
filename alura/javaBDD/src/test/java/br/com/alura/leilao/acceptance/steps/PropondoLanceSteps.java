...
//    	leilao = new Leilao("Tablete X");
//    	usuario1 = new Usuario("fulano");
//    	lance10 = new Lance(usuario1, BigDecimal.TEN);
//
//    	usuario2 = new Usuario("beltrano");
//    	lance15 = new Lance(usuario2, new BigDecimal("15.0"));
//    }

    @Dado("um lance de {double} reais do usuario {string}")
    public void um_lance_de_reais_o_usuario_fulano(Double valor, String nomeUsuario) {
    ...
    public void o_segundo_lance_eh_aceito() {
        Assert.assertEquals(1, leilao.getLances().size());
        Assert.assertEquals(this.lista.get(0).getValor(), leilao.getLances().get(0).getValor());
    }
}
